...
y1b <- o[c(1,3)] ## to return multiple outputs, a single bracket operator must ne used, double brackets does not support multiple elements
...
HW1[1:2,] ## print first two columns
